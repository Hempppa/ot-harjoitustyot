...
class DiffRenderer:
    ...
    def render(self):
        ...
        self._display.blit(easy_text, (self.option_rect.x-30, self.option_rect_list[0].y+10))
        ...
        self._display.blit(medium_text, (self.option_rect.x -30, self.option_rect_list[1].y+10))
        ...
        self._display.blit(hard_text, (self.option_rect.x-30, self.option_rect_list[2].y+10))
