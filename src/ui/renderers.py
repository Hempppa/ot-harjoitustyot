...
class MenuRenderer:
    ...
    def __init__(self, display, rect=(100,200,550,75), rect_colour=(100,100,100)):
        ...
        for i in range(len(option_text_list)):
            self.option_rect_list.append([pygame.Rect((left, top, width, height)), rect_colour])
    ...
    def get_rect_info(self):
        ...
        """
        return [rect[0] for rect in self.option_rect_list]
    ...
    def render(self):
        ...
        for rect, colour in self.option_rect_list:
            pygame.draw.rect(self._display, colour, rect)

        for object, parameter in self.draw_object_list[1:]:
...
class LBRenderer(DiffRenderer):
    ...
    def get_option_texts(self):
        ...
        self.option_rect_list.append([pygame.Rect(self.option_rect[0], self.option_rect[1]-20, self.option_rect[2], 470), (100, 100, 100)])
        self.option_rect_list.append([pygame.Rect(self.option_rect[0], self.option_rect[1]-20, self.option_rect[2], self.option_rect[3]-25), (30, 30, 30)])
        self.option_rect_list.append([pygame.Rect(self.option_rect[0]+2, self.option_rect[1]-18, self.option_rect[2]-4, self.option_rect[3]-29), (100, 100, 100)])
        texts = []
        return texts
    ...
    def render(self):
        ...
        for object, parameter in self.score_list[:]:
            self._display.blit(object, parameter)
...
class CustomRenderer(DiffRenderer):
    ...
    def __init__(self, display, rect=(70, 200, 200, 75)):
        ...
        self.height_info = ["16", False, (380, rect[1]+50, rect[2], rect[3])]
        self.mines_info = ["30", False, (rect[0], rect[1]+250, rect[2]*2, rect[3])]
        self.colours = [(10,10,10), (30,30,50)]

    def get_option_texts(self):
        self.draw_object_list.append([self.fonts[1].render("16", True, (255, 255, 255)), (80, self.option_rect[1]+60)])
        self.draw_object_list.append([self.fonts[1].render("16", True, (255, 255, 255)), (390, self.option_rect[1]+60)])
        self.draw_object_list.append([self.fonts[1].render("30", True, (255, 255, 255)), (80, self.option_rect[1]+260)])
        self.draw_object_list.append([self.fonts[3].render("Width (1-38):", True, (255, 255, 255)), (70, self.option_rect[1]+10)])
        self.draw_object_list.append([self.fonts[3].render("Height (1-18):", True, (255, 255, 255)), (380, self.option_rect[1]+10)])
        self.draw_object_list.append([self.fonts[3].render("Mines (1-684):", True, (255, 255, 255)), (70, self.option_rect[1]+210)])
        ...
        self.option_rect_list.append([pygame.Rect(self.option_rect[0], self.option_rect[1]+50, self.option_rect[2], self.option_rect[3]), (10, 10, 10)])
        self.option_rect_list.append([pygame.Rect(380, self.option_rect[1]+50, self.option_rect[2], self.option_rect[3]), (10, 10, 10)])
        self.option_rect_list.append([pygame.Rect(self.option_rect[0], self.option_rect[1]+250, self.option_rect[2]*2, self.option_rect[3]), (10, 10, 10)])
        texts = []
        return texts
    ...
    def render(self):
        ...
        for i in range(len(rect_info)):
            if rect_info[i][1]:
                self.option_rect_list[i][1] = self.colours[1]
            else:
                self.option_rect_list[i][1] = self.colours[0]
        return super().render()
...
class LBInputRenderer(CustomRenderer):
    ...
    def get_option_texts(self):
        ...
        self.option_rect_list.append([pygame.Rect(self.option_rect[0], self.option_rect[1], self.option_rect[2], self.option_rect[3]), (10, 10, 10)])
        texts = []
        return texts
