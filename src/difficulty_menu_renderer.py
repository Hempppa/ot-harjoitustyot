...
class DiffRenderer:
    def __init__(self, display):
        ...
        for i in range(self.options):
            self.option_rect_list.append(pygame.Rect(self.option_rect[0],self.option_rect[1]+100*i,self.option_rect[2],self.option_rect[3]))
    ...
    def render(self):
        ...
        diff_text = self.base_font.render("Easy:       9x9/10", True, (255,255,255))
        self._display.blit(diff_text, (self.option_rect.x-30, self.option_rect_list[0].y+10))

        pygame.draw.rect(self._display, (100,100,100), self.option_rect_list[1])
        custom_text = self.base_font.render("Medium:  16x16/40", True, (255,255,255))
        self._display.blit(custom_text, (self.option_rect.x-30, self.option_rect_list[1].y+10))

        pygame.draw.rect(self._display, (100,100,100), self.option_rect_list[2])
        leaderboard_text = self.base_font.render("Hard:       30x16/99", True, (255,255,255))
        self._display.blit(leaderboard_text, (self.option_rect.x-30, self.option_rect_list[2].y+10))
