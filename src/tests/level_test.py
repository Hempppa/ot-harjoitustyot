...
class TestLevel(unittest.TestCase):
    ...
    def test_correct_amount_of_cell_sprites(self):
        #1 handler
        self.assertEqual(len(self.sprite_handler1.all_other_cells.sprites()), 16*16)
    ...
    def test_correct_amount_of_cell_covers(self):
        #1
        self.assertEqual(len(self.sprite_handler1.cellCovers.sprites()), len(self.sprite_handler1.all_other_cells.sprites()))
